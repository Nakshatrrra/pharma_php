...
<body>
            ...
            <span class="topber__title--text">
                <?php
                    if ( 'dashboard' == $id ) {
                        ...
                        echo "Salesmans";
                    }elseif ( 'addMedicine' == $id ) {
                        echo "Add Medicine";
                    } elseif ( 'allMedicine' == $id ) {
                        echo "Medicines";
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><i id="left" class="fas fa-laugh-wink"></i> My Pharma</h3>
    ...
    echo " active";
            ...
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole ) {?>
                <!-- For Admin, Manager, Pharmacist-->
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addMedicine' == $id ) {
                                                                            echo " active";
                                                                        }?>">
                    <a href="index.php?id=addMedicine"><i id="left" class="fas fa-user-plus"></i>Add Medicine</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allMedicine' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allMedicine"><i id="left" class="fas fa-user"></i>All Medicines</a>
            </li>
        ...
        <footer class="text-center"><span>RNM</span><br>©2023 RNM All right reserved.</footer>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
                    ...
                    <div class="total">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="total__box text-center">
                                    <h1><?php
                                            $query = "SELECT COUNT(*) totalMedicine FROM medicines;";
                                                $result = mysqli_query( $connection, $query );
                                                $totalMedicine = mysqli_fetch_assoc( $result );
                                            echo $totalMedicine['totalMedicine'];
                                            ?></h1>
                                    <h2>Medicine</h2>
                                </div>
                            </div>
...
<!-- ============================================= medicines new====================================== -->
            ...
            <div class="medicine">
                        ...
                        <div class="main__table">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $getMedicine = "SELECT * FROM medicines";
                                            $result = mysqli_query( $connection, $getMedicine );
                                        ...
                                        <tr>
                                            ...
                                            <td><?php printf( "%s", $medicine['ref_id'] );?></td>
                                            <td><?php printf( "%s", $medicine['name'] );?></td>
                                            <td><?php printf( "%s", $medicine['price'] );?></td>
                                            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole ) {?>
                                                <!-- For Admin, Manager, Pharmacist-->
                                                <td><?php printf( "<a href='index.php?action=editMedicine&id=%s'><i class='fas fa-edit'></i></a>", $medicine['ref_id'] )?></td>
                                                <td><?php printf( "<a class='delete' href='index.php?action=deleteMedicine&id=%s'><i class='fas fa-trash'></i></a>", $medicine['ref_id'] )?></td>
                                            <?php }?>
                                        </tr>
                            ...
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="int" ref_id="ref_id" placeholder="Reference id" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                ...
                <?php if ( 'editMedicine' == $action ) {
                        $medicineID = $_REQUEST['id'];
                        $selectMedicine = "SELECT * FROM medicines WHERE id='{$ref_id}'";
                        $result = mysqli_query( $connection, $selectMedicine );
                            ...
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="int" name="red_id" placeholder="reference id" value="<?php echo $medicine['ref_id']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="text" name="name" placeholder="Name of medicine" value="<?php echo $medicine['name']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-envelope"></i>
                                            <input type="int" name="price" placeholder="price" value="<?php echo $medicine['price']; ?>" required>
                                        </label>
                                    </div>
                ...
                <?php if ( 'deleteMedicine' == $action ) {
                        $medicineID = $_REQUEST['id'];
                        $deleteMedicine = "DELETE FROM medicines WHERE id ='{$medicinesID}'";
                        $result = mysqli_query( $connection, $deleteMedicine );
                        header( "location:index.php?id=allMedicine" );
                        ob_end_flush();
                }?>
            </div>
            <!-- ---------------------- Medicines new ------------------------ -->
